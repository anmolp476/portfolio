  ...
  return (
    <Layout>
      <div name="The main div" >
        ...
        <div name="The header container" className="flex flex-col mt-24 text-5xl w-full mb-2">
          <p>
            Relevant <span className="text-blue-700">Work Experience</span>,
          </p>
        </div>

        <div name="The content div" className="w-3/5">

          <div name="The python tutor div" className="w-full">

            <div name="The python tutor header div" className="flex flex-row justify-between w-full text-2xl">
