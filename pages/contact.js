...
const Contact = () => {
  return (
    <Layout>
      <div name="This is the main div" className="flex flex-row w-3/5 h-full">
        ...
        <form method="POST" action="https://getform.io/f/870afaff-27e3-41f6-86fe-e980cd28f7ed" className="mt-4 flex flex-col items-center gap-8 justify-center w-full h-full">
          ...
          <div name="This will contain the header text" className="flex flex-col w-full">
            ...
            <div name="This contains the part of the header that is not capitalized" className="flex flex-row">
          ...
          <div name="This div will contain only the button. I covered it with a div so I can style the button easier" 
               className="h-full w-1/5 flex flex-row justify-center mb-4 -mt-8">
            <button className="text-white border-2 hover:bg-blue-700 hover:border-blue-700 px-4 py-3 my-8 mx-auto flex items-center">Let's Talk!</button>
          </div>
        </form>
